	...
	return (
		<div>
          ...
          <div className='lg:pl-32 lg:pr-32 lg:pt-6 flex lg:flex-col gap-8 pt-4 flex-col'>
					...
					<div>
						<h3 className='font-bold text-3xl text-gray-600'>Challenges</h3>
						<p className='text-gray-500 text-lg lg:pt-4'>
						...
						<ul className="list-disc lg:pt-4">
          ...
          <div>
            <h3 className='font-bold text-3xl text-gray-600'>Strategy</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>PixelPulse, with its extensive experience in SEO optimization, devised a comprehensive strategy tailored to TechInnovators Inc.'s unique requirements:</p>
            <h4 className='font-bold text-2xl text-gray-600'>Keyword research</h4>
            <p className='text-gray-500 text-lg lg:pt-4'>PixelPulse began by conducting in-depth keyword research to identify high-value keywords relevant to TechInnovators Inc.'s industry. This involved:</p>
            <ul className="list-disc">
              <li className='text-lg lg:pt-4'>Identifying industry-specific keywords and long-tail keywords.</li>
              <li className='text-lg lg:pt-4'>Analyzing competitor keywords to gain a competitive edge.</li>
              <li className='text-lg lg:pt-4'>Determining keyword search volume and competition level.</li>
            </ul>
          </div>
          <div>
            <h3 className='font-bold text-2xl text-gray-600'>Content optimization</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>Content is king in the digital world. PixelPulse's content optimization strategy included:</p>
            <li className='text-lg lg:pt-4'>Updating and enhancing existing content for relevance and value.</li>
            <li className='text-lg lg:pt-4'>Creating new, engaging content to attract and retain visitors.</li>
            <li className='text-lg lg:pt-4'>Implementing SEO best practices for on-page and off-page optimization.</li>
          </div>
          <div>
            <h3 className='font-bold text-2xl text-gray-600'>Technical SEO audit</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>PixelPulse conducted a comprehensive technical SEO audit to address underlying issues affecting website performance:</p>
            <ul className="list-disc">
            <li className='text-lg lg:pt-4'>Resolving technical errors and issues that hindered indexing.</li>
            <li className='text-lg lg:pt-4'>Improving site speed and mobile-friendliness.</li>
            <li className='text-lg lg:pt-4'>Enhancing site architecture for improved user experience.</li>
            </ul>
          </div>
          <div>
            <h3 className='font-bold text-3xl text-gray-600'>Competitor analysis</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>Understanding the competition was crucial:</p>
            <ul className="list-disc">
            <li className='text-lg lg:pt-4'>Analyzing competitors' SEO strategies.</li>
            <li className='text-lg lg:pt-4'>Identifying gaps and opportunities in the market.</li>
            <li className='text-lg lg:pt-4'>Tailoring TechInnovators Inc.'s SEO strategy for competitive advantage.</li>
            </ul>
          </div>
          <div>
            <h3 className='font-bold text-3xl text-gray-600'>On-page SEO</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>PixelPulse implemented on-page SEO techniques to boost visibility and engagement:</p>
            <ul className="list-disc">
              <li className='text-lg lg:pt-4'>Optimizing meta tags, headers, and image alt text.</li>
              <li className='text-lg lg:pt-4'>Improving internal linking for a better user experience.</li>
              <li className='text-lg lg:pt-4'>Ensuring each page had a clear call-to-action (CTA).</li>
            </ul>
          </div>
          <div className='lg:pt-8'>
            <h3 className='font-bold text-3xl text-gray-600'>Results</h3>
            <p className='text-gray-500 text-lg lg:pt-4'>The partnership between TechInnovators Inc. and PixelPulse produced remarkable results:</p>
            <h4 className='font-bold text-2xl text-gray-600 lg:pt-4'>Traffic increase by 200%</h4>
            <p className='text-gray-500 text-lg lg:pt-4'>TechInnovators Inc. experienced a substantial surge in organic traffic, allowing them to reach a wider audience.</p>
            <h4 className='font-bold text-2xl text-gray-600 lg:pt-4'>40% improvement in keyword rankings</h4>
            <p className='text-gray-500 text-lg lg:pt-4'>Keyword rankings for industry-specific terms saw a significant improvement, placing TechInnovators Inc. higher on SERPs.</p>
            <h4 className='font-bold text-2xl text-gray-600 lg:pt-4'>Conversion rate tripled</h4>
            <p className='text-gray-500 text-lg lg:pt-4'>The website's conversion rate tripled, indicating that visitors were not only more engaged but also more likely to become clients.</p>
            <h4 className='font-bold text-2xl text-gray-600 lg:pt-4'>Bounce rate reduced by 90%</h4>
            <p className='text-gray-500 text-lg lg:pt-4'>PixelPulse's optimization efforts resulted in a remarkable 90% reduction in bounce rate, indicating that visitors were staying on the site longer and exploring more content.</p>
          </div>
      ...
      <div className='flex gap-6 lg:hidden lg:w-[700px] pt-6 flex-col'>
        ...
        <div>
          ...
          <p className='lg:pt-2 font-bold text-xl lg:pt-12'>Emily Johnson</p>

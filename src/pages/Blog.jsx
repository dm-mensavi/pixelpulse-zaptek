...
const Projects = () => {
    return (
        <div className="Page">
            ...
            <div className="mt-52 max-w-[70%] mb-32">
            <h1 className="text-blue-900 font-bold">Blog</h1>
                <h1 className="lg:text-7xl md:text-6xl sm:text-6xl font-bold py-5 lg:w-[90%] md:w-full sm:w-full">Stay informed and  inspired</h1>
